...
const web_hook_client_1 = __nccwpck_require__(8689);
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            core_1.default.setOutput("webhook url - ", `${webHookUrl}`);
            core_1.default.setOutput("message - ", `${message}`);
            const wc = new web_hook_client_1.WebHookClient(webHookUrl);
            const res = yield wc.postChatMessageAndCreateTask(message);
            core_1.default.setOutput("API", res.data);
        }
        catch (error) {
...
class WebHookClient {
    constructor(webHookUrl) {
        ...
        this.webHookBaseUrl = "https://hook.swit.io";
    ...
    postChatMessageAndCreateTask(message) {
        return __awaiter(this, void 0, void 0, function* () {
